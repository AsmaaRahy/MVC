namespace Task1MVC.Models
{
    public class SampleDataDoctor
    {
        ...
        public SampleDataDoctor()
        {
            ...
            new Doctor { Id = 2, Name = "Dr. William Clark ", Specialization = "Pediatrics", Img = "doctor2.jpg" },
            ...
            new Doctor { Id = 5, Name = "Dr. Sarah Johnson", Specialization = "Neurology", Img = "doctor5.jpg" },
            };
        }
    }
}
